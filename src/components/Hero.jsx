...
export default function Hero() {
  const words = [
    "Frontend Developer ",
    "Skill: React, NodeJS, Express, MongoDB",
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Programming lover 🚀 | Fontend Developer 🔧 | 
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/rehan606"
                  target="_blank"
                ...
                <a
                  href="https://docs.google.com/document/d/13IgiaTJtNRc2bxW_w7VB1Z99DTd5MHwl/edit?usp=sharing&ouid=111496451740013282586&rtpof=true&sd=true"
                  target="_blank"
